...
\subsection{B90 Sicilian}\label{b90-sicilian}

\section{Black}\label{black-2}

\subsection{E80 King's Indian}\label{e80-kings-indian}

\subsection{E63 King's Indian}\label{e63-kings-indian}
...
Pal Benko wrote this puzzle and made a bet with Bobby Fischer that he
would not be able to solve it within 30 minutes of thinking. Bobby lost
the bet, and could not solve the puzzle within the allotted time. The
puzzle is white to move and a mate in 3.
